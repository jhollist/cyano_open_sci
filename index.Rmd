...
- [Hollister and Stachelek (To Be Submitted)](https://github.com/usepa/lakemorpho_manuscript)
]
...
- Trophic state and chlorophyll **a**
    - Random forest
    - Heirarchical Bayes
- Phytoplankton community models
- Temporal and spatial dynamics of cyanobacteria blooms
- Lake photic zone temperature

<img src="https://media.giphy.com/media/qJsJI0MhazjGw/giphy.gif" style="width: 80%; height: 80%; margin-left: 10%;"></img>
...
.left-column[
- National 
- Uses National Lakes Assessment Data and Landcover
- `randomForest` package
- Rolled-own variable selection
- All variables (water quality and GIS): 68.7% Total Accuracy
- GIS only variables: 49% Total Accuracy
- But ...]

.right-column[
![probmap](figure/prob_map_ecosphere.jpg)
]
